...
export default function Navbar() {
  return (
    <nav className="border-b bg-white sticky top-0 z-50">
      <div className="w-full flex items-center gap-6 pt-3 pb-1 px-8 max-w-7xl ">
        ...
        <div className="flex-1 flex items-center">
          <div className="flex items-stretch w-full border border-[#e6e6e6] rounded-full bg-[#f8f7f4] px-0 py-[4px]">
            <input
              id="top-search"
        ...
        <div className="flex items-center gap-6 text-sm flex-shrink-0 ml-aut">
